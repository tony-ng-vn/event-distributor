/**
 * Route tests for GET /api/cron/archive-finished. Auth is a bearer token from
 * CRON_SECRET; the archive service is mocked. Vercel cron fires a GET request.
 */
...
import { GET } from "@/app/api/cron/archive-finished/route";
...
describe("GET /api/cron/archive-finished", () => {
  beforeEach(() => {
